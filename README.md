...
/_/  |_|___/___/     |___/_/  |_/____/_/ /_/___//____/_/ /_/ /_/ /_/  |_|
```
...
├──────────────────────────────────────────────────────────────────────────┤
│ 23yo fullstack engineer, IIIT Delhi CS '24, based in New Delhi, IN       │
│ Currently: Software Engineer @ Dock.us (Next.js / Node / GraphQL)        │
│ Past: Founding Engineer @ Turgon AI  ·  SDE @ AccioJob (YC 2021)         │
│ Taught 100,000+ students to code  ·  Published 2 books  ·  Ex-founder    │
└──────────────────────────────────────────────────────────────────────────┘
```
...
├──────────────────────────────────────────────────────────────────────────┤
│ 2025 - now   |  Software Engineer      |  Dock.us                        │
│ 2024 - 2025  |  Founding Engineer      |  Turgon AI                      │
│ 2022 - 2024  |  SDE + Instructor       |  AccioJob (YC 2021)             │
│ 2021 - 2022  |  Founder                |  STV Technologies               │
│ 2022         |  Fullstack Intern       |  Attrilu                        │
│ 2022         |  Mobile App Intern      |  Fitzura                        │
└──────────────────────────────────────────────────────────────────────────┘
```

```
┌──────────────────────────────────────────────────────────────────────────┐
│ visitor@github:~$ ls -la ~/stack                                         │
├──────────────────────────────────────────────────────────────────────────┤
│ frontend   React, Next.js, React Native, TypeScript, Three.js / R3F      │
│             Tailwind CSS, Framer Motion, GSAP, Redux, Zustand            │
│                                                                          │
│ backend    Node.js, NestJS, Express, Django, Flask, GraphQL, MongoDB     │
│                                                                          │
│ ai / ml    LangChain, Vercel AI SDK, OpenAI API, Eleven Labs             │
│             MediaPipe (hand + head tracking, gesture control)            │
│                                                                          │
│ devops     AWS (SQS/EC2), Docker, GitHub Actions, Vercel, Prisma         │
...
```
┌──────────────────────────────────────────────────────────────────────────┐
│ visitor@github:~$ cat projects.json | head                               │
├──────────────────────────────────────────────────────────────────────────┤
│ > Portfolio v3 (avivashishta.com)                                        │
│   React 19 + Three.js + MediaPipe -- gesture & head-tracking UI          │
│                                                                          │
│ > BOLDBot                                                                │
│   Next.js + NestJS -- AI-automated Instagram customer service            │
│                                                                          │
│ > AI Messaging Helper                                                    │
│   React Native + Flask + OpenAI -- turns thoughts into messages          │
│                                                                          │
│ > BOLD Store                                                             │
│   React Native + Firebase -- one-click marketplace from your feed        │
└──────────────────────────────────────────────────────────────────────────┘
```

```
┌──────────────────────────────────────────────────────────────────────────┐
│ visitor@github:~$ tail -n 4 achievements.txt                             │
├──────────────────────────────────────────────────────────────────────────┤
│ [x] 100,000+ developers taught  ·  300+ features shipped @ AccioJob      │
│ [x] 500+ PRs reviewed as Founding Engineer @ Turgon AI                   │
│ [x] Co-founded STV Technologies -- INR 10,00,000 in revenue              │
│ [x] 2 published books  ·  "Lockdown Wars" podcast -- 100k+ streams       │
└──────────────────────────────────────────────────────────────────────────┘
```
